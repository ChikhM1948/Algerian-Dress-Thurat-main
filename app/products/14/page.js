        ...
        <div className="bg-white p-6 rounded-lg shadow-lg border border-[#FF8BA7]">
          ...
          <div className="mt-6 border-t border-[#FF8BA7] pt-6">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              <strong>La Taqendurt </strong> est la robe traditionnelle portée par les femmes de Kabylie. Caractérisée par des broderies géométriques multicolores, elle est souvent accompagnée d’un large ceinturon (Amekraz), de bijoux en argent (Tazerzit), et d’un foulard coloré (Achewiq).
...
•	Yelles-Chaouche, Malika. "Le costume kabyle : langage, identité et transmission." In Insaniyat. Revue algérienne d’anthropologie et de sciences sociales, n°28, 2005, pp. 45-61. [CNRS/CRASC]
