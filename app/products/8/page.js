      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg border border-[#FF8BA7]">
          ...
          <div className="mt-6 flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold">La gandoura Karanfla</h1>
          ...
          <div className="mt-6 border-t border-[#FF8BA7] pt-6">
            ...
            <p className="text-gray-800 text-lg leading-relaxed">
              <strong>La gandoura Karanfla</strong> est une tunique longue, ample, avec ou sans manches, portée principalement en Afrique du Nord. Elle est confectionnée en laine ou en coton et se présente souvent avec des rayures colorées ou en blanc uni.
            </p>
            
            <div className="mt-4 bg-[#FFF0F3] p-4 rounded-lg border border-[#FF8BA7]">
              <p className="text-gray-800">
                Cette version, appelée "Karanfla" (qui fait référence aux œillets ou aux clous de girofle en arabe), est particulièrement appréciée dans la région d'Annaba. Elle se distingue par ses motifs subtils et son élégance simple, ce qui en fait un vêtement polyvalent adapté à diverses occasions.
              </p>
            </div>
            
            <p className="mt-4 text-gray-800 text-lg">
              La gandoura est un vêtement à la fois pratique et élégant, offrant confort et aisance de mouvement tout en respectant les codes vestimentaires traditionnels. Elle peut être portée seule pendant les journées chaudes ou superposée à d'autres vêtements quand les températures sont plus fraîches.
            </p>
          </div>
